  ...
  return (
    <PageTransition>
      <div ref={containerRef} style={{ display: 'flex', flexDirection: 'column', minHeight: '200vh', background: 'var(--color-bg)' }}>
        ...
        <div ref={headerRef} style={{ width: '100%', height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', position: 'absolute', top: 0, left: 0, zIndex: 0 }}>
          <h1 className="font-serif" style={{ fontSize: 'clamp(3rem, 7vw, 6rem)', letterSpacing: '0.1em' }}>LAYANAN KAMI</h1>
          <p className="text-muted" style={{ marginTop: '2rem', fontSize: '1.2rem', letterSpacing: '0.2em', textTransform: 'uppercase' }}>Tailored experiences for your unique story.</p>
        </div>
